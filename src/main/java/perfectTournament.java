/**
 * <p>A derived class for a tournament containing a number of even pools that is equal to a power of two.</p>
 * This type of tournament differs from other tournaments that do not have an equal number of pools in having an obvious
...
public class perfectTournament extends evenTournament {
    ...
    /**
     * <p>Constructor for a perfect Tournament containing a number of evenly sized pools that are
     * equal to a power of two.</p>
